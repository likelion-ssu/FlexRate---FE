...
function predict(inputData: Record<number, number>): number {
  const features = [
    2, 0, 16, 9, 1, -2, -2, 0, -2, -2, 10, 12, -2, -2, 11, -2, -2, 1, 10, 6, -2,
    -2, 4, -2, -2, 4, 2, -2, -2, 10, -2, -2, 16, 1, 20, 2, -2, -2, 10, -2, -2,
    2, 0, -2, -2, 20, -2, -2, 10, 12, 3, -2, -2, 2, -2, -2, 2, 0, -2, -2, 20,
    -2, -2,
  ];
  ...
  const leftChildren: number[] = [
    1, 2, 3, 4, 5, -1, -1, 8, -1, -1, 11, 12, -1, -1, 15, -1, -1, 18, 19, 20,
    -1, -1, 23, -1, -1, 26, 27, -1, -1, 30, -1, -1, 33, 34, 35, 36, -1, -1, 39,
    -1, -1, 42, 43, -1, -1, 46, -1, -1, 49, 50, 51, -1, -1, 54, -1, -1, 57, 58,
    -1, -1, 61, -1, -1,
  ];
  ...
  for (let i = 0; i < features.length; i++) {
    nodes.push(
      new DecisionTreeNode(features[i], thresholds[i], values[i], null, null),
    );
  }
